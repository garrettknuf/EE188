...
The [OSVVM VHDL verification utility library](https://opensource.ieee.org/osvvm/osvvm) implements advanced verification capabilities that are simple to use and feel like built-in language features.  These include:   
...
[OsvvmLibraries](https://opensource.ieee.org/osvvm/OsvvmLibraries) 
...
For directions on running the demos, see [OSVVM Scripts](https://opensource.ieee.org/osvvm/OSVVM-Scripts#readme).
...
as submodules of [OsvvmLibraries](https://opensource.ieee.org/osvvm/OsvvmLibraries).
